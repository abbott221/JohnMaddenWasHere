...
public class Page_Event07 extends Abstract_GenericCheckBox {
	
	
	public Page_Event07(MainCoreClass coreIn) {
		
		super(coreIn);
		
		
		
		this.title.setText("7. Match appropriate reservoir(s)"
				+ " and / or river(s) with NWS notification");
	...
	public void sendPacket() {
		...
		theURL.append("page=" + "seven" +"&"); //page = "three"&
