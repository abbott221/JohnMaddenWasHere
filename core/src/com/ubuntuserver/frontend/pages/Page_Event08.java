...
public class Page_Event08 extends Abstract_GenericCheckBox {
	
	
	public Page_Event08(MainCoreClass coreIn) {
		
		super(coreIn);
		
		
		
		this.title.setText("8. Follow appropriate"
				+ " reservoir(s) and / or river(s) procedures");
