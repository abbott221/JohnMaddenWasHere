...
public class Page_Event03 extends Abstract_GenericCheckBox {
	...
	public Page_Event03(MainCoreClass coreIn) {
		...
		this.title.setText("3. Match notification with Crisis Action System (CAS) Level");
	...
	public void sendPacket() {
		...
		theURL.append("page=" + "three" +"&"); //page = "three"&
