...
public class Page_Event3 extends Abstract_Screen {
	...
	public Page_Event3(MainCoreClass coreIn) {
		...
		temp = new Label("3. Match notification with Crisis Action System (CAS) Level", skin);
